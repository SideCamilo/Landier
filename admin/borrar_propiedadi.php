...
<ul class="nav" style="background:#000; height: 100px;">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Seleccione una propiedad para eliminar</h1>
                    </div>
                </div>
              ...
              <div class=" col-md-8 col-sm-12">
                  <div class="list-group">
                                ...
                                <h4 class="list-group-item-heading">propiedad a eliminar</h4>
                                <p class="list-group-item-text" style="line-height: 30px;">
                                <form action="scripts/delete.php" enctype="multipart/form-data" method="post">
                                   <table class="table  table-bordered ">
                              
                                <tbody>
                                 <tr>
                                        <td>Eliminar propiedad:</td>
                                        <td><select id="prop" name="prop" class="form-control">
                                    ...
                                    <tr>
										<td></td>
										<td>
											<button type="submit" class="btn btn-default" style = "background-color: #d5b560; border-radius: 0px;">Eliminar</button>
										</td>
									</tr>
                                </tbody>
                            </table>
